...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            _context.Departament.AddRange(d1,d2,d3,d4);//addrange permite adicionar vários objetos de uma vez
            ...
            /*
             * A operação seed e chamada dentro da classe startup, no método configure
             */
